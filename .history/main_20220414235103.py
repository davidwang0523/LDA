...
if __name__ == '__main__':
    ...
    plt.annotate('local max', xy=(coherence_scores.index(max(coherence_scores))+1, max(coherence_scores)),xycoords='data',arrowprops=dict(facecolor='black', shrink=0.05))
    plt.show()
