...
if __name__ == '__main__':
    ...
    print(model.print_topics(num_topics=coherence_scores.index(max(coherence_scores))+1,num_words=20))
    ...
    plt.annotate("Best"+"\n"+"coherence score: "+str(max(coherence_scores))+"\n"+"number of topics: "+str(coherence_scores.index(max(coherence_scores))+1), xy=(coherence_scores.index(max(coherence_scores))+1, max(coherence_scores)),xycoords='data')
    plt.show()
