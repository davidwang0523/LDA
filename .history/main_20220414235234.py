...
if __name__ == '__main__':
    ...
    plt.annotate("The highests coherence score: "+str(max(coherence_scores))+" "+"The best number of topics: "+str(coherence_scores.index(max(coherence_scores))+1), xy=(coherence_scores.index(max(coherence_scores))+1, max(coherence_scores)),xycoords='data')
    plt.show()
