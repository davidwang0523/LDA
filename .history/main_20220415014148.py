...
if __name__ == '__main__':
    ...
    min_topics, max_topics = 1, 20
    coherence_scores = list(get_coherence_values(min_topics, max_topics))
    print("The highests coherence score: "+str(max(coherence_scores))+" "+"The best number of topics: "+str(coherence_scores.index(max(coherence_scores))+1))
    x = [int(i) for i in range(min_topics, max_topics)]
    documents, dictionary, model = run_lsa_process(train_data,str(coherence_scores.index(max(coherence_scores))))
    print(model.print_topics(str(coherence_scores.index(max(coherence_scores)))))
    ...
    plt.annotate("The highests coherence score: "+str(max(coherence_scores))+"\n"+"The best number of topics: "+str(coherence_scores.index(max(coherence_scores))+1), xy=(coherence_scores.index(max(coherence_scores))+1, max(coherence_scores)),xycoords='data')
    plt.show()
    # plt.savefig("outputplt.png")
